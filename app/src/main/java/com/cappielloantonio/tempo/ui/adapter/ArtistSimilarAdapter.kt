...
class ArtistSimilarAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val view =
            ItemLibrarySimilarArtistBinding.inflate(
    ...
    fun getItem(position: Int): SimilarArtistID3? = artists.get(position)
    ...
    inner class ViewHolder internal constructor(
        var item: ItemLibrarySimilarArtistBinding,
