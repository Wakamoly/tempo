...
class GenreCatalogueFragment : Fragment(), ClickCallback {
    ...
    private fun initGenreCatalogueView() {
        bind!!.genreCatalogueRecyclerView.setLayoutManager(GridLayoutManager(requireContext(), 2))
        bind!!.genreCatalogueRecyclerView.addItemDecoration(GridItemDecoration(2, 16, false))
