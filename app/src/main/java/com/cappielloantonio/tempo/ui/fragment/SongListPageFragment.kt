...
class SongListPageFragment :
    ...
    private fun init() {
        if (requireArguments().getString(Constants.MEDIA_RECENTLY_PLAYED) != null) {
            ...
            bind!!.pageTitleLabel.text = songListPageViewModel!!.genre.genre
            ...
            bind!!.pageTitleLabel.text = getString(R.string.song_list_page_downloaded)
            ...
            bind!!.pageTitleLabel.text = songListPageViewModel!!.album.name
        }
    }
