...
class AlbumCatalogueAdapter(
...
) : RecyclerView.Adapter<AlbumCatalogueAdapter.ViewHolder?>(),
    Filterable {
    ...
    override fun onCreateViewHolder(
        ...
        val view =
            ItemLibraryCatalogueAlbumBinding.inflate(
    ...
    inner class ViewHolder internal constructor(
        var item: ItemLibraryCatalogueAlbumBinding,
    ...
    fun sort(order: String) {
        when (order) {
            ...
            Constants.ALBUM_ORDER_BY_ARTIST ->
                albums.sort(
                    Comparator.comparing<AlbumID3?, String?>(
                        AlbumID3::artist,
