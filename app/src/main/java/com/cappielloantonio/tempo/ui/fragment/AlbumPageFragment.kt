...
class AlbumPageFragment :
    ...
    private fun init() {
        albumPageViewModel!!.setAlbum(
            getViewLifecycleOwner(),
            requireArguments().getParcelable<AlbumID3?>(
    ...
    private fun initAppBar() {
            ...
            .observe(
                ...
                Observer { album: AlbumID3? ->
                    if (bind != null && album != null) {
                        ...
                        bind!!.albumSongCountDurationTextview.text =
                            getString(
                        ...
                        if (album.releaseDate != null && album.originalReleaseDate != null) {
                            if (album.releaseDate!!.getFormattedDate() != null ||
                                album.originalReleaseDate!!.getFormattedDate() != null
                            ) {
                                bind!!.albumReleaseYearsTextview.visibility =
                                    View.VISIBLE
                            } else {
                                bind!!.albumReleaseYearsTextview.visibility = View.GONE
                            }

                            if (album.releaseDate!!.getFormattedDate() == null || album.originalReleaseDate!!.getFormattedDate() == null) {
                                bind!!.albumReleaseYearsTextview.text =
                                    getString(
                            ...
                            if (album.releaseDate!!.getFormattedDate() != null && album.originalReleaseDate!!.getFormattedDate() != null) {
                                if (album.releaseDate!!.year == album.originalReleaseDate!!.year &&
                                    album.releaseDate!!.month == album.originalReleaseDate!!.month &&
                                    album.releaseDate!!.day == album.originalReleaseDate!!.day
                                ) {
                                    bind!!.albumReleaseYearsTextview.text =
                                        getString(
                                            R.string.album_page_release_date_label,
        ...
        bind!!.albumOtherInfoButton.setOnClickListener(
    ...
    private fun initAlbumInfoTextButton() {
        bind!!.albumArtistLabel.setOnClickListener(
            View.OnClickListener { v: View? ->
                albumPageViewModel!!
                    .getArtist()
                    .observe(
                ...
                Observer { albumInfo: AlbumInfo? ->
                    if (albumInfo != null) {
                        ...
                        if (bind != null && albumInfo.lastFmUrl != null && !albumInfo.lastFmUrl!!.isEmpty()) {
                            bind!!.albumNotesTextview.setOnClickListener(
                                View.OnClickListener { v: View? ->
            ...
            .observe(
                ...
                Observer { songs: MutableList<Child?>? ->
                    if (bind != null && !songs!!.isEmpty()) {
                        bind!!.albumPagePlayButton.setOnClickListener(
                            View.OnClickListener { v: View? ->
                        ...
                        bind!!.albumPageShuffleButton.setOnClickListener(
                            View.OnClickListener { v: View? ->
