...
@UnstableApi
class DownloadHorizontalAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val view =
            ItemHorizontalDownloadBinding.inflate(
    ...
    fun getItem(id: Int): Child? = grouped.get(id)
        ...
        when (view) {
            Constants.DOWNLOAD_TYPE_TRACK -> return filterSong(
                ...
                songs
                    ...
                    }.filter(Util.distinctByKey<Child?>(Child::id))
            ...
            Constants.DOWNLOAD_TYPE_ALBUM -> return filterSong(
                ...
                songs
                    ...
                    }.filter(Util.distinctByKey<Child?>(Child::albumId))
                    .collect(
                        Collectors.toList(),
                    ),
            )
            ...
            Constants.DOWNLOAD_TYPE_ARTIST -> return filterSong(
                ...
                songs
                    ...
                    }.filter(Util.distinctByKey<Child?>(Child::artistId))
                    .collect(
                        Collectors.toList(),
                    ),
            )
            ...
            Constants.DOWNLOAD_TYPE_GENRE -> return filterSong(
                ...
                songs
                    ...
                    }.filter(Util.distinctByKey<Child?>(Child::genre))
                    .collect(Collectors.toList()),
            )
            ...
            Constants.DOWNLOAD_TYPE_YEAR -> return filterSong(
                ...
                songs
                    ...
                    }.filter(Util.distinctByKey<Child?>(Child::year))
                    .collect(Collectors.toList()),
            )
        }
        ...
        if (filterValue != null) {
            when (filterKey) {
                Constants.DOWNLOAD_TYPE_TRACK ->
                    return songs
                        .stream()
                        .filter { child: Child? -> child!!.id == filterValue }
                        .collect(
                            Collectors.toList(),
                        )
                ...
                Constants.DOWNLOAD_TYPE_ALBUM ->
                    return songs
                        .stream()
                        .filter { child: Child? -> child!!.albumId == filterValue }
                        .collect(
                            Collectors.toList(),
                        )
                ...
                Constants.DOWNLOAD_TYPE_GENRE ->
                    return songs
                        .stream()
                        .filter { child: Child? -> child!!.genre == filterValue }
                        .collect(
                            Collectors.toList(),
                        )
                ...
                Constants.DOWNLOAD_TYPE_YEAR ->
                    return songs
                        .stream()
                        .filter { child: Child? -> child!!.year == filterValue.toInt() }
                        .collect(
                            Collectors.toList(),
                        )
                ...
                Constants.DOWNLOAD_TYPE_ARTIST ->
                    return songs
                        .stream()
                        .filter { child: Child? -> child!!.artistId == filterValue }
                        .collect(
                            Collectors.toList(),
                        )
            }
    ...
    private fun initTrackLayout(
        ...
        holder.item.downloadedItemSubtitleTextView.text =
        ...
        if (position > 0 && grouped.get(position - 1) != null && (
                grouped.get(position - 1).album !=
                    grouped
                        .get(
                            position,
                        ).album
            ...
            holder.item.divider.setPadding(
                ...
                holder.itemView.context.resources
                    .getDimension(R.dimen.downloaded_item_padding)
                    .toInt(),
                0,
                0,
            )
    ...
    inner class ViewHolder internal constructor(
        var item: ItemHorizontalDownloadBinding,
